...
<div class="container py-4">
  <div class="row gx-2 justify-content-center gap-3">
    ...
    <div class="col-6 col-lg-2" >
      <div class="container noselect">
        <div class="canvas">
          <!-- 25 trackers -->
          <!-- These trackers create the 3D hover effect -->
          ...
          <div id="card">
            <img class="img-fluid" style="width:100%; height:100%; object-fit:cover;" src="../Server/uploads/1750970868-Picture1.jpg" alt="">
          </div>
        </div>
      </div>
    </div>

    <!-- Copy this block 4 more times -->
    <div class="col-6 col-lg-2"><div class="container noselect">
        <div class="canvas">
          <!-- 25 trackers -->
          <!-- These trackers create the 3D hover effect -->
          <div class="tracker tr-1"></div><div class="tracker tr-2"></div><div class="tracker tr-3"></div><div class="tracker tr-4"></div><div class="tracker tr-5"></div>
    ...
    <div class="col-6 col-lg-2">…same block…</div>
